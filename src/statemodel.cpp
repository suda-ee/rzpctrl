      ...
      hHeader(3), vHeader(4)
{
    insertColumns(0, 3);
    insertRows(0, 4);
    setHeaderData(0, Qt::Horizontal, trUtf8("通断"));
    setHeaderData(1, Qt::Horizontal, trUtf8("忙闲"));
    setHeaderData(2, Qt::Horizontal, trUtf8("速率(kbits/s)"));
    setHeaderData(0, Qt::Vertical, trUtf8("光纤"));
    setHeaderData(1, Qt::Vertical, trUtf8("无线Mesh"));
